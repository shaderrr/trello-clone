...
export default function BoardPage() {
  ...
  const { data: session } = useSession(); // Get the Outlook session
  ...
  async function handleCreateTask(e: React.FormEvent<HTMLFormElement>) {
    ...
    // If the user is connected to Outlook and the task was created successfully with a due date
    if (newTask && taskData.dueDate && taskData.assignee) {
      await fetch("/api/create-outlook-event", {
        method: "POST",
        ...
        body: JSON.stringify({
          ...
          assigneeEmail: newTask.assignee, // Pass the assignee's email
        }),
      });
    }
